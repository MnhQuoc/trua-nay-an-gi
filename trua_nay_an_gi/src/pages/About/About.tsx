            ...
            <div className="container">
                <div className="row align-items-center">                
                    <div className="col-md-6">
                        ...
                        <a href="#book-table" className="btn btn-primary btn-sm w-md mt-4">Book a table</a>
                    </div>
                    <div className="col-md-6">
                        <div className="row">
                            <div className="col">
                                <img src="/about-1.jpg" alt="Restaurant interior view" className="w-100 rounded shadow" />
                            </div>
                            <div className="col">
                                <img src="/about-2.jpg" alt="Restaurant interior view" className="w-100 rounded shadow" />
                            </div>
                        </div>                  
                    </div>
                </div>
                ...
                <div className="row align-items-center">
                    ...
                    <div className="col-md-6 order-1 order-sm-first">
                        <div className="row">
                            <div className="col">
                                <img src="/about-3.jpg" alt="Food preparation" className="w-100 rounded shadow" />
                            </div>
                            <div className="col">
                                <img src="/about-4.jpg" alt="Food preparation" className="w-100 rounded shadow" />
                            </div>
                        </div>                  
                    </div>
                </div>
